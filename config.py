...
API_DELAY = float(os.getenv("NCBI_API_DELAY", "0.5"))  # Reduced default delay for concurrent execution
MAX_RETRIES = int(os.getenv("NCBI_MAX_RETRIES", "3"))

# Parallelism setting: Default is 4 to prevent NCBI IP Ban, user can scale it up to CPU core count (e.g. 20 or 40)
